...
// .wrangler/tmp/bundle-xSJubu/checked-fetch.js
...
function renderHtml(env3, contents) {
  let text_body = list2str([1, 2, 3, 4], "-");
  console.log(str2list(text_body, "-"));
  return `
<!DOCTYPE html>
<html lang="ja">
...
// .wrangler/tmp/bundle-xSJubu/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-xSJubu/middleware-loader.entry.ts
