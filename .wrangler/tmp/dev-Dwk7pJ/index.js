...
// .wrangler/tmp/bundle-JCsPpf/checked-fetch.js
...
function renderHtml(contents) {
  let text_body = "";
  contents.forEach((e) => {
    text_body += `<h2 name=${e.title}> ${e.title}<h2>`;
  });
  const text_css = `
...
<head>
    ...
    <style type="text/css">${text_css}</style>
    
</head>

<body>
    <p><h1>\u3059\u3079\u3042\u306A\u754C\u9688\u89E3\u8AAD\u96C6(\u03B2)</h1></p>
    <p>\u3059\u3079\u3042\u306A\u754C\u9688\u306E\u6697\u53F7\u306E\u89E3\u8AAD\u7D50\u679C\u306E\u691C\u7D22\u3084\u6295\u7A3F\u304C\u3067\u304D\u307E\u3059</p>
    <p>${text_body}</p>
</body>
</html>`;
}
...
var src_default = {
  async fetch(request, env3, ctx) {
    const { results } = await env3.d1 - imicipher.prepare(
      "SELECT * FROM musics"
    ).all();
    return new Response(
      renderHtml(results),
...
// .wrangler/tmp/bundle-JCsPpf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-JCsPpf/middleware-loader.entry.ts
