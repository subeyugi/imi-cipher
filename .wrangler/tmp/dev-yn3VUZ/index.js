...
// .wrangler/tmp/bundle-Yu0D3A/checked-fetch.js
...
// src/renderHtml.ts
function renderHtml(env3, contents) {
  let text_body = "";
  return `
<!DOCTYPE html>
<html lang="ja">
...
var src_default = {
  async fetch(request, env3, ctx) {
    ...
    getDecipherFromSongId(env3, [1, 2, 3]);
    return new Response(
      renderHtml(env3, results),
      {
...
// .wrangler/tmp/bundle-Yu0D3A/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Yu0D3A/middleware-loader.entry.ts
